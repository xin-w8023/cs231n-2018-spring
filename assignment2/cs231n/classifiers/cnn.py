...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        ar1, ar1_cache = affine_relu_forward(crp1, W2, b2)
        scores, out_cache = affine_forward(ar1, W3, b3)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dp, dw2, db2 = affine_relu_backward(dp, ar1_cache)
        dp, dw1, db1 = conv_relu_pool_backward(dp, crp1_cache)
